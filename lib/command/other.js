...
cmd.on("ownerr", ["ownerbot", "owner"], ["other"], async (msg, res) => {
  const vcard = 'BEGIN:VCARD\n'
	+ 'VERSION:3.0\n' 
	+ 'FN:TdrckAlfa\n'
	+ 'ORG:Ig : @theodorickalfa09_;\n'
	+ 'TEL;type=CELL;type=VOICE;waid=6285746657092:+62 857-4665-7092\n'
	+ 'END:VCARD'
	client.sendMessage(msg.from, {displayname: "TethaBot Owner", vcard: vcard}, "contactMessage")
});
