        ...
        list_now++;
			...
			if (jam >= '03' && jam <= '10') {
				...
				ucapanWaktu = 'Selamat Malam'
                  ...
                  d = new Date().getDay();
                  var week = d;
                  let weton = ['pahing', 'pon','wage','kliwon','legi'][Math.floor(d) % 5]; //tdrckalfa
                  switch(week) {
                   case 0: week = "Minggu"; break;
                   case 1: week = "Senin"; break;
                   case 2: week = "Selasa"; break;
                   case 3: week = "Rabu"; break;
                   case 4: week = "Kamis"; break;
                   case 5: week = "Jum'at"; break;
                   case 6: week = "Sabtu"; break;
                  }
...
${stayhalal} Menuju Bulan Ramadhan 1443 Hijriyah

❏ *Hari:* ${week} ${weton}
❏ *Tanggal:* ${momentw.tz('Asia/Jakarta').format('DD MMMM YYYY')}
❏ *Pukul:* ${momentw.tz('Asia/Jakarta').format('HH.mm')} WIB
❏ *Runtime:* ${rt.hours} Jam ${rt.minutes} Menit`,
