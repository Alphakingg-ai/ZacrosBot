...
cmd.on("daftar", ["daftar", "regis"], ["other"], async (msg, res) => {
  try {
   client.sendButton(msg.from, "Berhasil mendaftarkanmu sebagai member!!\n\nKetik #menu untuk membuka list perintah", "conversation", [{id: "ngoke", text: "Ngoke🤝"}], {footer: "© TethaBot | By TdrckAlfa"})
    } catch(e) {
    console.log(e)
    }
});
