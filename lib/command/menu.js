  ...
  async (msg, { prefix, client, query, usedPrefix }) => {
    ...
    if (!cmd._tags[type]) {
      ...
      return client.sendMessageFromContent(msg.from, {
        listMessage: {
          title: `*${ucapanWaktu} ${msg.sender.name}!*`,
          description: `Tekan tombol yang bertuliskan "Daftar Menu" yaa!\n\nBot ini 100% gratis dan tanpa fitur berbayar!`,
          footerText: `© Tethabot | by TdrckAlfa`,
